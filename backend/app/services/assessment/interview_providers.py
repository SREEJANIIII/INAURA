...
Current mode (per user request):
  * LOCAL LLM at http://localhost:1234/v1/chat/completions (ling-3.0-tiny) is the ONLY active provider; /api/v1/chat also supported (auto-converts messages->input).
