...
export const PAGES: SearchResult[] = [
  ...
  },
  {
    id: "page:analysis",
    label: "Run Analysis",
    detail: "Choose a role, add evidence, run the analysis",
    kind: "Page",
    to: "/analysis",
    keywords: ["evidence", "github", "linkedin", "leetcode", "notion", "upload", "sources"],
  },
  {
    id: "page:results",
    label: "Analysis Results",
    detail: "Priority gaps, skill quadrants and readiness",
    kind: "Page",
    to: "/analysis/results",
    keywords: ["gaps", "quadrants", "overview", "score", "report"],
  },
  {
    id: "page:skill-assessments",
    label: "Skill Assessment",
    detail: "Test what you know and validate a skill",
    kind: "Page",
    to: "/analysis/results#skill-assessments",
    keywords: ["quiz", "test", "validate", "assessments"],
  },
  {
    id: "page:dsa",
    label: "DSA",
    ...
    kind: "Page",
    to: "/analysis/results#dsa",
    keywords: ["algorithms", "data structures", "problems", "leetcode"],
  },
  {
    id: "page:interview",
  ...
  },
  {
    id: "page:ats",
    label: "ATS Tester",
    detail: "Check how your resume reads to a screener",
    kind: "Page",
    to: "/resume/ats-tester",
    keywords: ["resume", "cv", "score", "keywords", "applicant tracking"],
  },
  {
    id: "page:roadmap",
    label: "Roadmap",
  ...
  },
  {
    id: "page:revision",
    label: "Revision",
    detail: "Flashcards for what you're learning",
    kind: "Page",
    to: "/revision",
    keywords: ["flashcards", "cards", "recall", "practice"],
  },
  {
    id: "page:profile",
    label: "Profile",
