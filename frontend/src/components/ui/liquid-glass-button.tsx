"use client"
/* Pasted shadcn-style component: it exports variant helpers next to components, and MetalButton
   detects touch screens on mount. Both are intended, so these two rules are off for this file only. */
    ...
    <>
      ...
      >
        <div className="absolute top-0 left-0 z-0 h-full w-full rounded-full
            shadow-[0_0_6px_rgba(0,0,0,0.03),0_4px_14px_-4px_rgba(62,48,140,0.22),inset_3px_3px_0.5px_-3.5px_rgba(255,255,255,0.95),inset_-3px_-3px_0.5px_-3.5px_rgba(255,255,255,0.8),inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.9),inset_-1px_-1px_1px_-0.5px_rgba(92,80,160,0.28),inset_0_0_6px_6px_rgba(255,255,255,0.16),inset_0_0_2px_2px_rgba(255,255,255,0.1),0_0_12px_rgba(255,255,255,0.3)]
        transition-all
        ...
        {/* With asChild, Slottable marks the element (e.g. a link) that becomes the button,
            so the glass layers above and below end up inside it */}
        <Slottable>
          {asChild ? children : <div className="pointer-events-none z-10 ">{children}</div>}
        </Slottable>
        <GlassFilter />
      </Comp>
    </>
